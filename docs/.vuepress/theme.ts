...
export default hopeTheme({
  hostname: 'https://yanfancode.github.io/blog',

  author: {
    name: 'yanfan',
    url: 'https://github.com/YanFanCode/blog',
  ...
  repo: 'https://github.com/YanFanCode/blog',
  docsBranch: 'master',
  docsDir: 'docs',
  ...
  blog: {
    ...
    roundAvatar: true,
    medias: {
      GitHub: 'https://github.com/YanFanCode'
      // JueJin: [
  ...
  plugins: {
    ...
    comment: {
      ...
      provider: 'Waline',
      serverURL: 'https://blog-waline-6c6ofi82t-yanfancode.vercel.app/'
    },
