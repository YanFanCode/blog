import{_ as c}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as d,c as t,a as s,b as n,e,w as o,f as l}from"./app-25f2f90b.js";const r={},u={href:"https://github.com/Stephen-wzw/webpack-demo",target:"_blank",rel:"noopener noreferrer"},v=l(`<h2 id="打包图片资源" tabindex="-1"><a class="header-anchor" href="#打包图片资源" aria-hidden="true">#</a> 打包图片资源</h2><p>在项目中引入图片文件夹，并添加两张图片：</p><p><strong>project</strong></p><div class="language-diff line-numbers-mode" data-ext="diff"><pre class="language-diff"><code><span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line"> webpack-demo
